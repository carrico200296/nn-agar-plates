...
def config():
    ...
    # default values
    data_name = "bottle"
    train_data_path = os.getcwd() + "/dataset/" + data_name + "/train/good"
...
if __name__ == "__main__":
    ...
    #########################################
    cfg = config()
    cfg.save_path = os.getcwd() + "/DFR-Baseline"
    # cfg.model_name = ""
    ...
    data_names = ['bottle'] # to test only wth the bottle dataset

    # train or evaluation
    for data_name in data_names:
        cfg.data_name = data_name
        cfg.train_data_path = os.getcwd() + "/dataset/" + data_name + "/train/good"
        cfg.test_data_path = os.getcwd() + "/dataset/" + data_name + "/test"
